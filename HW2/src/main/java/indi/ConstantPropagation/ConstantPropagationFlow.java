...
public class ConstantPropagationFlow {
    Map<Local, ConstantPropagationValue> local2CPValue;

    public ConstantPropagationFlow(Map<Local, ConstantPropagationValue> map) {
        local2CPValue = map;
    }

    public static ConstantPropagationFlow meet(ConstantPropagationFlow map1, ConstantPropagationFlow map2) {
        ConstantPropagationFlow resMap = new ConstantPropagationFlow(new HashMap<>());
    ...
    public boolean equals(Object o) {
        ...
        ConstantPropagationFlow that = (ConstantPropagationFlow) o;
